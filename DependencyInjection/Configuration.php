                ...
                ->always(function ($v) {
                    ...
                    if (empty($v['service']['client_manager'])
                        ...
                        throw new InvalidArgumentException(
                            'The service client_manager must be set explicitly for custom db_driver.'
                        );
                    }
                    ...
                    if (empty($v['service']['access_token_manager'])
                        ...
                        throw new InvalidArgumentException(
                            'The service access_token_manager must be set explicitly for custom db_driver.'
                        );
                    }
                    ...
                    if (empty($v['service']['refresh_token_manager'])
                        ...
                        throw new InvalidArgumentException(
                            'The service refresh_token_manager must be set explicitly for custom db_driver.'
                        );
                    }
                    ...
                    if (empty($v['service']['auth_code_manager'])
                        ...
                        throw new InvalidArgumentException(
                            'The service auth_code_manager must be set explicitly for custom db_driver.'
                        );
                    }
